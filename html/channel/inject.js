...
function iqiyiInject(){
    api.execScript({
        ...
        'setInterval(function(){'+
           ...
           'if($(".m-video-player-wrap").length>0){$(".m-video-player-wrap").html("<div id='+"myVideo"+' style='+"width:100%;height:56.25vw;background:black;position:relative;"+'><img style='+"position:absolute;width:15vw;height:15vw;top:50%;left:50%;margin-left:-7.5vw;margin-top:-7.5vw;"+' src='+"http://phmbl28h4.bkt.clouddn.com/%E6%92%AD%E6%94%BE.png?e=1542358764&token=KV2kt9gYxcmQKmj82L9BdIEXv7hPosHAP7ZZTh_q:JEpb8T4JG0vQxBN7OFBUnN5aZAA"+' /></div>")};'+
           //点击事件
   ...
   api.execScript({
       ...
       script: ''+
           ...
           //封面图
            ...
            //删除播放器
            'document.querySelectorAll(".video-area")[0].innerHTML="<img style='+"position:absolute;width:15vw;height:15vw;top:50%;left:50%;margin-left:-7.5vw;margin-top:-7.5vw;"+' src='+"http://phmbl28h4.bkt.clouddn.com/%E6%92%AD%E6%94%BE.png?e=1542358764&token=KV2kt9gYxcmQKmj82L9BdIEXv7hPosHAP7ZZTh_q:JEpb8T4JG0vQxBN7OFBUnN5aZAA"+' />";'+
...
function souhuInject(progress){
 api.execScript({
     ...
     //播放器
      ...
      'if($("#top-poster").length>0){$("#top-poster").html("<div id='+"myVideo"+' style='+"width:100%;height:56.25vw;background:black;position:relative;"+'><img style='+"position:absolute;width:15vw;height:15vw;top:50%;left:50%;margin-left:-7.5vw;margin-top:-7.5vw;"+' src='+"http://phmbl28h4.bkt.clouddn.com/%E6%92%AD%E6%94%BE.png?e=1542358764&token=KV2kt9gYxcmQKmj82L9BdIEXv7hPosHAP7ZZTh_q:JEpb8T4JG0vQxBN7OFBUnN5aZAA"+' /></div>")};'+
      'if($(".player-view").length>0){$(".player-view").html("<div id='+"myVideo"+' style='+"width:100%;height:100%;background:black;position:absolute;top:0;left:0;"+'><img style='+"position:absolute;width:15vw;height:15vw;top:50%;left:50%;margin-left:-7.5vw;margin-top:-7.5vw;"+' src='+"http://phmbl28h4.bkt.clouddn.com/%E6%92%AD%E6%94%BE.png?e=1542358764&token=KV2kt9gYxcmQKmj82L9BdIEXv7hPosHAP7ZZTh_q:JEpb8T4JG0vQxBN7OFBUnN5aZAA"+' /></div>")};'+
...
function pptvInject(progres){
 api.execScript({
       ...
       '$("#playerbox").html("<div id='+"myVideo"+' style='+"width:100%;height:56.25vw;background:black;position:relative;"+'><img style='+"position:absolute;width:15vw;height:15vw;top:50%;left:50%;margin-left:-7.5vw;margin-top:-7.5vw;"+' src='+"http://phmbl28h4.bkt.clouddn.com/%E6%92%AD%E6%94%BE.png?e=1542358764&token=KV2kt9gYxcmQKmj82L9BdIEXv7hPosHAP7ZZTh_q:JEpb8T4JG0vQxBN7OFBUnN5aZAA"+' /></div>");'+
...
function miGuInject(progres){
  api.execScript({
      ...
      'if($(".video").length>0){$(".video").html("<div id='+"myVideo"+' style='+"width:100%;height:56.25vw;background:black;position:relative;"+'><img style='+"position:absolute;width:15vw;height:15vw;top:50%;left:50%;margin-left:-7.5vw;margin-top:-7.5vw;"+' src='+"http://phmbl28h4.bkt.clouddn.com/%E6%92%AD%E6%94%BE.png?e=1542358764&token=KV2kt9gYxcmQKmj82L9BdIEXv7hPosHAP7ZZTh_q:JEpb8T4JG0vQxBN7OFBUnN5aZAA"+' /></div>")};'+
...
function yijiulinwuInject(){
  api.execScript({
      ...
      '$("#player").html("<div id='+"myVideo"+' style='+"width:100%;height:56.25vw;background:black;position:relative;"+'><img style='+"position:absolute;width:15vw;height:15vw;top:50%;left:50%;margin-left:-7.5vw;margin-top:-7.5vw;"+' src='+"http://phmbl28h4.bkt.clouddn.com/%E6%92%AD%E6%94%BE.png?e=1542358764&token=KV2kt9gYxcmQKmj82L9BdIEXv7hPosHAP7ZZTh_q:JEpb8T4JG0vQxBN7OFBUnN5aZAA"+' /></div>");'+
      'var func=function(){api.sendEvent({name:"play",extra:{poster:window.poster,pageUrl:location.href,title:window.title,platform:"咪咕视频"}});};'+
  ...
  api.execScript({
      ...
      'window.getDataTimer=setInterval(function(){'+
          ...
          'if(($("#player").length>0) || ($("#pop").length>0)){'+
                 ...
                 'wrap.html("<div id='+"myVideo"+' style='+"width:100%;height:56.25vw;background:black;position:relative;"+'><img style='+"position:absolute;width:15vw;height:15vw;top:50%;left:50%;margin-left:-7.5vw;margin-top:-7.5vw;"+' src='+"http://phmbl28h4.bkt.clouddn.com/%E6%92%AD%E6%94%BE.png?e=1542358764&token=KV2kt9gYxcmQKmj82L9BdIEXv7hPosHAP7ZZTh_q:JEpb8T4JG0vQxBN7OFBUnN5aZAA"+' /></div>");'+
...
function leshiInject(){
  api.execScript({
      ...
      '$(".playB").html("<div id='+"myVideo"+' style='+"width:100%;height:56.25vw;background:black;position:relative;"+'><img style='+"position:absolute;width:15vw;height:15vw;top:50%;left:50%;margin-left:-7.5vw;margin-top:-7.5vw;"+' src='+"http://phmbl28h4.bkt.clouddn.com/%E6%92%AD%E6%94%BE.png?e=1542358764&token=KV2kt9gYxcmQKmj82L9BdIEXv7hPosHAP7ZZTh_q:JEpb8T4JG0vQxBN7OFBUnN5aZAA"+' /></div>");'+
 ...
 api.execScript({
     ...
     'var getPlayerTimer=setInterval(function(){'+
          ...
          'if(document.querySelector("#playerBox")){'+
               'isGetPlayer=false;'+
               'document.querySelector("#playerBox").innerHTML="<div id='+"myVideo"+' style='+"width:100%;height:56.25vw;background:black;position:relative;"+'><img style='+"position:absolute;width:15vw;height:15vw;top:50%;left:50%;margin-left:-7.5vw;margin-top:-7.5vw;"+' src='+"http://phmbl28h4.bkt.clouddn.com/%E6%92%AD%E6%94%BE.png?e=1542358764&token=KV2kt9gYxcmQKmj82L9BdIEXv7hPosHAP7ZZTh_q:JEpb8T4JG0vQxBN7OFBUnN5aZAA"+' /></div>";'+
